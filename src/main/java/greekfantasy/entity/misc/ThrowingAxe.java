...
public class ThrowingAxe extends ThrowableItemProjectile {
    ...
    protected static final EntityDataAccessor<Boolean> PICKUP = SynchedEntityData.defineId(ThrowingAxe.class,
    ...
    protected void onHitEntity(EntityHitResult raytrace) {
        ...
        if (entity instanceof LivingEntity) {
            ...
            this.setBaseDamage(
                    this.getBaseDamage() + EnchantmentHelper.getDamageBonus(this.getItem(), living.getMobType()));
        }

        Entity thrower = getOwner();
        var source = this.damageSources().thrown(this, (thrower == null) ? this : thrower);
